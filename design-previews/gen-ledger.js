...
const topbar = (armed) => `<div class="topbar"><span><span class="red">●</span> DOOMGUARD</span><span>${armed}</span></div>`;
...
<div class="scr">
  ...
  <div class="slip">
    ...
    <div class="r-center">
      <div class="r-brand">DOOMGUARD<span class="r-reg">®</span></div>
...
<div class="scr">
  ...
  <div class="slip">
    ...
    <div class="chk"><span class="box">2</span><span>ENABLE ACCESSIBILITY SERVICE
      <small>Find "Doomguard Reel Counter" in the list and switch it on. This is how the app knows when you're watching reels.</small></span></div>
    <hr class="dash"/>
