 ...
 * Doomguard (counterpoint to the shipped dark "Hazard Console" theme).
 *
...
const footPrivacy = `<div class="foot">Doomguard only reads Instagram &amp; YouTube's screen, <b>nothing else</b>, and your count lives only on this device.</div>`;
...
<div class="scr">
  ...
  <div style="margin-top:20px">${modeSwitch("block", "Block (pro). Doomguard backs you out of every reel and short.")}</div>
  ${footPrivacy}
</div>`;
